...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2021/08/14 17:39:04 by ade-blas          #+#    #+#              #
#    Updated: 2021/11/02 17:05:14 by ade-blas         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
OBJS	= $(SRCS:.c=.o)
BONUS_S	= ft_lstnew_bonus.c ft_lstadd_front_bonus.c ft_lstadd_back_bonus.c ft_lstsize_bonus.c ft_lstlast_bonus.c \
